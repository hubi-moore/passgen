...
<html lang="en"><head>
<meta charset="UTF-8">
<title>Random Password Generator - forked from codepen.io</title>
...
<body translate="no">
  <div class="container">
	...
	<div class="result">
		...
		<div class="result__viewbox" id="result">Click Button below</div>
		<button id="copy-btn" style="--x:124px; --y:37px; opacity: 1; pointer-events: all;"><i class="far fa-copy"></i></button>
	</div>
	<div class="length range__slider" data-min="4" data-max="32">
		<div class="length__title field-title" data-length="16">length:</div>
		<input id="slider" type="range" min="4" max="32" value="16" style="background: linear-gradient(90deg, rgb(11, 30, 223) 42.8571%, rgba(255, 255, 255, 0.216) 42.9571%);">
	</div>
